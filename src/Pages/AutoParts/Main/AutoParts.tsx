  ...
  return (
    ...
    >
      <Box sx={{ flex: 1 }}>
        ...
        >
          <Typography>
            Наша компанія займається розбиранням вантажних автомобілів
            Mercedes-Benz (запчастини Мерседес). В асортименті нові та б/в
            запчастини та комплектуючі до автомобілів. В наявності: бампери,
            крила, двері, двигуни, редуктора, осі, амортизатори і т.д.
          </Typography>

          <Box sx={{ marginTop: "25px" }}>
            <Typography sx={{ fontSize: "18px", marginBottom: "30px" }}>
              Є запчастини до вантажних Мерседесів 609, 711,
              814,1117,1320,1524,1722,1827,1835,2435, VARIO, Atego, Actros,
              Axor.
            </Typography>
            <Typography sx={{ fontSize: "18px" }}>
              Ми дбаємо про наших клієнтів, тому здійснюємо доставку запчастин
              різними кур'єрськими службами або самовивіз.
            </Typography>
          </Box>
